...
<h1 class="title">Filters <span>Tools</span></h1>
...
$products = [
    [
        ...
        "image" => "filters2.jpg",
        "details" => [
            "Natural and not subjected to the bleaching process, may add a paper taste to coffee.",
        ],
        "price" => 30
    ],
    [
        ...
        "image" => "filters3.jpg",
        "details" => [
            "Treated with oxygen or chlorine to remove the brown color, does not add paper flavor."
        ],
        "price" => 30
    ]
];
